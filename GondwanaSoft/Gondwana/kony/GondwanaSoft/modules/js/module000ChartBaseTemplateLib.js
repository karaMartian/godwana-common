...
__kdv_base_properties.dataLabels = function() {
    ...
    var value = {
        ...
        "connector": {
            ...
            /* [(invalid, missing key = NULL)] */"visible": false
            /* [Datatype : boolean] */
            /* [true, false, 1, 0] */
            /* [(invalid = false), (missing = true )] */
            ,
...
__kdv_base_properties.plotPoints = function() {
    ...
    var value = {
        ...
        ,
        "marker": {
            /* [(invalid = Default Map), (missing = Default Map )] */"type": ["circle"]
            /* [Datatype : ] */
...
__kdv_base_properties.candleStick = function() {
    ...
    var value = {
        ...
        ,
        "up": {
            /* [(invalid, missing = Default Map) ] */"fillType": ["color"]
            /* [(invalid, missing = [ "color" ])] */
            /* ["color", "none"] */
        ...
        "down": {
            /* [(invalid, missing = Default Map) ] */"fillType": ["none"]
            /* [(invalid, missing = [ "color" ])] */
            /* ["color", "none"] */
            /* [fillType : N.A for ticker] */
            ,
...
__kdv_base_properties.kdv_base_chartProperties = function() {
    var value = {
        ...
        "layer1": {
            ...
            ,
            "layerArea": {
                /* [(invalid, missing key = NULL - Transparent Chart surface)] */"border": __kdv_base_properties.border()
                /* [(invalid, missing key = NULL )] */
                ,
            ...
            "title": {
                /* [(invalid, missing key = NULL)] */"visible": true
                /* [Datatype : boolean] */
                /* [true, false, 1, 0] */
                /* [(invalid = false), (missing = true )] */
                ,
                ...
                /* [% value] */
                ,
                /* [(invalid, missing key = 15), (clamp to 0 - 100)] */"margin": [0, 0, 0, 0]
                /* [left, right, top, bottom] */
            ...
            "lineChart": {
                /* [lineChart - missing key = Default Map] */"columnId": [0]
                ...
                ,
                /* [(missing, invalid = "normal")] */"dataAlignToAxis": ["primaryYAxis"]
            ...
            "areaChart": {
                ...
                /* [(missing, invalid, (sizeof(Array)=0) = all column ids in dataset)] */
                ,
                /* "colorIndicator" : [single/multi series - always columns], */"animations": __kdv_base_properties.animations()
                /* [(missing, invalid = NULL)] */
                ,
                "graphType": "normal"
                /* [(missing, invalid = "normal")] */
                ...
                ,
                "area": {
                    /* [(missing, invalid = Default map)] */"fillType": ["color"]
                    /* ["color", "gradient"] */
                    ...
                    ,
                    /* [(invalid values, missing key = ["0xFFFFFFFF"]) ] */"colorAboveXAxis": ["0x00ff00ff"]
                ...
                "line": {
                    /* [invalid, missing = NULL] */"visible": true
                    /* [Datatype : boolean] */
                    /* [true, false, 1, 0] */
                    /* [(invalid = false), (missing = true )] */
                    ,
            ...
            "pieChart": {
                ...
                /* [(missing, invalid, (sizeof(Array)=0) = all column ids in dataset)] */
                ,
                /* "colorIndicator" : [single series - rows], */"animations": __kdv_base_properties.animations()
                /* [(missing, invalid = NULL)] */
                ,
                "spinWheel": false
                /* [Datatype : boolean] */
            ...
            "donutChart": {
                ...
                /* [(missing, invalid, (sizeof(Array)=0) = all column ids in dataset)] */
                ,
                /* "colorIndicator" :[single/multi series : rows], */"animations": __kdv_base_properties.animations()
                /* [(missing, invalid = NULL)] */
                ,
                "spinWheel": false,
                "plotZeroValues": false,
