...
function callAppMenu() {
    var appMenu = [
        ["appmenuitemid1", "Map", "option5.png", appmenuitemid1_callback_seq0,
        {
            selectedImage: ""
        }],
        ["appmenuitemid2", "Dashboard", "option6.png", appmenuitemid2_callback_seq0,
        {
            selectedImage: ""
        }]
    ];
    kony.application.createAppMenu("GondwanaSoftAppMenu", appMenu, null, null);
    kony.application.setCurrentAppMenu("GondwanaSoftAppMenu");
}